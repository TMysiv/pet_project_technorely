...
export class CompaniesService {
    ...
    async createCompany(companyDto: CreateCompanyDto): Promise<Company> {
        ...
        const checkCompany = await this.prismaService.company.findFirst({where: {name}});
    ...
    async updateCompanyById(companyId: number, updateDto: UpdateCompanyDto): Promise<Company> {
